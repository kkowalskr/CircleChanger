...
class CircleChanger(object):
    ...
    def swallow(self, other_circle_changer):
        ...
        centerx = (self.circle.center.x +
                   other_circle_changer.circle.center.x)\
                                        / 2
        centery = (self.circle.center.y +
        ...
        return CircleChanger(centerx, centery, radius, 'red', colors)
    ...
    def change_to_next_color_in_tuple(self):
        ...
        self.index = ((len(self.colors) + self.index + 1) % len(
            self.colors))
